...
var pieChart = new Chart(pieChartElement, {
    ...
    data: {
        ...
        datasets: [{    
            ...
            borderColor: ['#c92e20', '#36bc4e', '#877c76'], // Add custom color border 
            backgroundColor: ['#c92e20', '#36bc4e', '#877c76'], // Add custom color background (Points and Fill)
